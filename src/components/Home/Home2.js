          ...
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
             I fell in love with what a few lines of <span className="purple"> code </span> can do for the world and I geared my curiosity to learn more. Now, I harness the power of technology to create innovative solutions and make a positive impact.
              ...
              <i>
                <b className="purple">Web Technologies and Apps </b> especially in areas related to{" "}
                <b className="purple">
                  AI, Blockchain, Automation, and Finance.
                </b>
              </i>
              <br />
              <br />
          ...
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              <li className="social-icons">
                <a
                  href="https://github.com/roomfulmoshe"
                  target="_blank"
                  rel="noreferrer"
              ...
              <li className="social-icons">
                <a
                  href="https://www.linkedin.com/in/mosheshtaygrud"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
